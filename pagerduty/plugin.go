...
func Plugin(ctx context.Context) *plugin.Plugin {
	p := &plugin.Plugin{
		...
		TableMap: map[string]*plugin.Table{
			...
			"pagerduty_incident_custom_field":       tablePagerDutyIncidentCustomField(ctx),
			...
			"pagerduty_business_service_dependency": tablePagerDutyBusinessServiceDependency(ctx),
